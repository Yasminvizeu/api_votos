...
//refazendo os ifs duplicados pra cada parametro
    ...
    public List<Produto> buscarPorParametroComCriteria(String nome, BigDecimal preco, LocalDate dataDeCadastro) {
        ...
        if (dataDeCadastro != null) {
            filtros = criteriaBuilder.and(filtros, criteriaBuilder.equal(from.get("dataDeCadastro"), dataDeCadastro));
        }
        query.where(filtros);
